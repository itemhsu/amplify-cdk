...
function override(resources) {
    resources.restApi.addPropertyOverride("Body", Object.assign(Object.assign({}, resources.restApi.body), { 'x-amazon-apigateway-request-validators': {
            'Validate body': {
    ...
    resources.restApi.addPropertyOverride(`Body.paths.${cloneModelPath}.x-amazon-apigateway-any-method`, Object.assign(Object.assign({}, resources.restApi.body.paths[cloneModelPath]["x-amazon-apigateway-any-method"]), { 'x-amazon-apigateway-request-validator': "Validate body" }));
    ...
    resources.restApi.addPropertyOverride(`Body.paths.${newModelPath}.x-amazon-apigateway-any-method`, Object.assign(Object.assign({}, resources.restApi.body.paths[newModelPath]["x-amazon-apigateway-any-method"]), { 'x-amazon-apigateway-request-validator': "Validate body" }));
